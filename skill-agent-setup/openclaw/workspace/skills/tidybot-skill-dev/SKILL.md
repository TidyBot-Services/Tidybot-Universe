...
description: Build, create, or develop skills for Tidybot robot. Use when asked to make a new robot skill or when you need an API, model, or service that doesn't exist yet.
---
